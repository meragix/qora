...
QoraMutationBuilder<void, UserUpdate, void>(
  ...
  options: MutationOptions(
    invalidates: [['users', currentUserId]], // Auto-refresh on success
...
QoraMutationBuilder<void, Todo, void>(
  ...
  options: MutationOptions(
    invalidates: [['todos']], // Auto-refresh on success or offline replay
...
QoraMutationBuilder<void, Todo, List<Todo>?>(
  ...
  options: MutationOptions(
    invalidates: [['todos']], // 4️⃣ Pull confirmed data from server
    onMutate: (todo) async {
