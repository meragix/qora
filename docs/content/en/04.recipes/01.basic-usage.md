...
This guide implements a complete user management feature: list view, detail view, and manual refresh flows. It demonstrates how caching, background revalidation, and invalidation compose in production code.

---

## Prerequisites

Install and configure `qora_flutter` as described in the [Setup guide](../flutter-integration/setup.md). The code below assumes:
